...
import {fetchStatistics, setFromDate, setToDate} from "../../store/statisticsSlice";
import {selectFromDate, selectStatisticsLoading, selectStats, selectToDate} from "../../store/statisticsSelects";
...
export const StatisticsPage = () => {
    ...
    const filterStats = () => {
        const tempStats = stats.filter(el => new Date(el.date) >= fromDate && new Date(el.date) <= toDate);
